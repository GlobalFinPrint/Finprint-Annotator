...
class AssignmentFilterDTO(object):
    ...
    def __init__(self, trip_filter={"id":-1,"name":"--- Filter by Trip ---"}, set_filter={"id":-1,"name":"--- Filter by Set ---"},
    ...
    def setFilterValues(self,trip_filter={"id":-1,"name":"--- Filter by Trip ---"}, set_filter={"id":-1,"name":"--- Filter by Set ---"}, anno_filter={"id":-1,"name":"--- Filter by Annotator ---"}, status_filter={"id":-1,"name":"--- Filter by Status ---"},
